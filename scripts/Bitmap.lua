...
function Bitmap.loadAllBitmaps()
	Bitmap.readImage('resources/graphics/boost.bmp')
	Bitmap.readImage('resources/graphics/input_display.bmp')
	Bitmap.readImage('resources/graphics/item_shroom0.bmp')
	Bitmap.readImage('resources/graphics/item_shroom1.bmp')
	Bitmap.readImage('resources/graphics/item_shroom2.bmp')
	Bitmap.readImage('resources/graphics/item_shroom3.bmp')
	Bitmap.readImage('resources/graphics/lap_1.bmp')
	Bitmap.readImage('resources/graphics/lap_2.bmp')
	Bitmap.readImage('resources/graphics/lap_3.bmp')
	Bitmap.readImage('resources/graphics/lap_4.bmp')
	Bitmap.readImage('resources/graphics/lap_5.bmp')
	Bitmap.readImage('resources/graphics/lap_empty.bmp')
	Bitmap.readImage('resources/graphics/lap_total2.bmp')
	Bitmap.readImage('resources/graphics/lap_total3.bmp')
	Bitmap.readImage('resources/graphics/lap_total4.bmp')
	Bitmap.readImage('resources/graphics/lap_total5.bmp')
